...
% Last Modified by GUIDE v2.5 04-Feb-2022 00:42:29
...
v0=str2num(get(handles.edit6,'string'));
...
f2=@(t, x, a) (1/m)*(-k.*x-b.*a);


h1=h;

n=(t_final-t_initial)/h1;
...
a(i+1)=a(i)+((h1*string(t(i)))/m)+(h1*(f2(t(i), x(i), a(i))));
